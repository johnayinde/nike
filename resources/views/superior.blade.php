                            ...
                            <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                                <div class="carousel-outer">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item">
                                            <img src="{{asset('img/room/superior/1.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/superior/2.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/superior/3.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/superior/4.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/superior/5.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/superior/6.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                        <div class="item active">
                                            <img src="{{asset('img/room/superior/7.jpg')}}" class="thumb-preview" alt="Superior Room">
                                        </div>
                                    </div>
                                    <!-- Controls -->
                                ...
                                <ol class="carousel-indicators thumbs visible-lg visible-md">
                                    <li data-target="#carousel-custom" data-slide-to="0" class="">
                                        <img src="{{asset('img/room/superior/1.jpg')}}" alt="Superior Room">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="1" class="">
                                        <img src="{{asset('img/room/superior/2.jpg')}}" alt="Superior Room">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/superior/3.jpg')}}" alt="Superior Room">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="3" class="">
                                        <img src="{{asset('img/room/superior/4.jpg')}}" alt="Superior Room">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="4" class="">
                                        <img src="{{asset('img/room/superior/5.jpg')}}" alt="Superior Room">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="5" class="">
                                        <img src="{{asset('img/room/superior/6.jpg')}}" alt="Superior Room">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="6" class="">
                                        <img src="{{asset('img/room/superior/7.jpg')}}" alt="Superior Room">
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <div class="rooms-features">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <ul class="condition">
                                                            <li>
                                                                <i class="flaticon-bed"></i>Queen Bed
                                                            </li>
                                                            <li>

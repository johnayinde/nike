<div style="padding: 0; margin: 0;">
    ...
    <div style="padding: 24px; background: white;">
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Room Type</p>
                    <p style="margin: 4px 0 0 0; font-size: 16px; font-weight: 600; color: #0f172a;">{{ $record->room }}</p>
                </div>
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Number of Rooms</p>
                    <p style="margin: 4px 0 0 0; font-size: 16px; font-weight: 600; color: #0f172a;">{{ $record->num_of_rooms }}</p>
                </div>
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Check-in Date</p>
                    <p style="margin: 4px 0 0 0; font-size: 16px; font-weight: 600; color: #0f172a;">{{ $record->checkin->format('F j, Y') }}</p>
                </div>
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Check-out Date</p>
                    <p style="margin: 4px 0 0 0; font-size: 16px; font-weight: 600; color: #0f172a;">{{ $record->checkout->format('F j, Y') }}</p>
                </div>
                <div style="grid-column: span 2;">
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Duration</p>
                    <p style="margin: 4px 0 0 0; font-size: 16px; font-weight: 600; color: #0f172a;">
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Payment Status</p>
                ...
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Order Status</p>
                    <p style="margin: 8px 0 0 0;">
                        <span style="display: inline-block; padding: 6px 12px; border-radius: 20px; font-size: 14px; font-weight: 600;
                ...
                <div>
                    <p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Rave Ref</p>
        ...
        <!-- Timestamps -->
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin-bottom: 0;">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                <div>

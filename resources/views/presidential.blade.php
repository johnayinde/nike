                            ...
                            <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                                <div class="carousel-outer">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img src="{{asset('img/room/presidential/1.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/presidential/2.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/presidential/3.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/presidential/4.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/presidential/5.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/presidential/6.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/presidential/7.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                    </div>
                                    <!-- Controls -->
                                ...
                                <ol class="carousel-indicators thumbs visible-lg visible-md">
                                    <li data-target="#carousel-custom" data-slide-to="0" class="">
                                        <img src="{{asset('img/room/presidential/1.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="1" class="">
                                        <img src="{{asset('img/room/presidential/2.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/presidential/3.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/presidential/4.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/presidential/5.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/presidential/6.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/presidential/7.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                </ol>
                            </div>
                        </div>

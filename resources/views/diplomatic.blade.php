    ...
    <div class="sub-banner overview-bgi">
        <div class="container">
            <div class="breadcrumb-area">
                <h1>Diplomatic Suite</h1>
                <ul class="breadcrumbs">
                    <li><a href="{{ url('/') }}">Home</a></li>
                    <li class="active">Rooms</li>
                    <li class="active">Diplomatic Suite</li>
                </ul><br>
                            ...
                            <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                                <div class="carousel-outer">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img src="{{asset('img/room/diplomatic/1.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/diplomatic/2.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/diplomatic/3.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/diplomatic/4.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/diplomatic/5.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/diplomatic/6.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                        <div class="item">
                                            <img src="{{asset('img/room/diplomatic/7.jpg')}}" class="thumb-preview" alt="Chevrolet Impala">
                                        </div>
                                    </div>
                                    <!-- Controls -->
                                ...
                                <ol class="carousel-indicators thumbs visible-lg visible-md">
                                    <li data-target="#carousel-custom" data-slide-to="0" class="">
                                        <img src="{{asset('img/room/diplomatic/1.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="1" class="">
                                        <img src="{{asset('img/room/diplomatic/2.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/diplomatic/3.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/diplomatic/4.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/diplomatic/5.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/diplomatic/6.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                    <li data-target="#carousel-custom" data-slide-to="2" class="">
                                        <img src="{{asset('img/room/diplomatic/7.jpg')}}" alt="Chevrolet Impala">
                                    </li>
                                </ol>
                            </div>
                        </div>

        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                {{-- <div class="item">
                    ...
                    <div class="carousel-caption banner-slider-inner banner-top-align">
                        <div class="banner-content text-center">
                            <h1 data-animation="animated fadeInLeft delay-05s"><span> A </span> Home </span> Away </span> From </span> Home</h1>
                            <p data-animation="animated fadeInLeft delay-1s">Comfort at its best</p>
                            <a href="{{url('/booking')}}" class="btn btn-md btn-theme" data-animation="animated fadeInLeft delay-15s">Book Now</a>
                            <a href="{{ url('/about') }}" class="btn btn-md border-btn-theme" data-animation="animated fadeInLeft delay-20s">Learn More</a>
                        </div>
                    </div>
                ...
                <div class="item">
                    <img src="{{asset('img/banner/banner-10.jpg')}}" alt="banner-slider-1">
                    <div class="carousel-caption banner-slider-inner banner-top-align">
                        <div class="banner-content text-center">
        ...
        <div class="row" align="left">
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6">
                <div class="text">
                    ...
                    <p>Landmark Nike Lake Resort is situated on the banks of Nike Lake in Enugu Nigeria. Enjoy the perfect business getaway with breathtaking views in a very secure and tranquil setting. A short fifteen minutes drive from the airport and only ten minutes from the city centre. All rooms overlook the beautiful gardens or the lake and each room provides the comfort and luxury that is expected from an international three star hotel...</p>
                    <br>
    ...
    <div class="overlay" style="background-color:#fffefe;padding-top:60px;margin-top:-30px;">
        <div class="container">
            ...
            <div class="main-title">
                <h1>Our Rooms</h1>
                <p>Select from our range of options.</p>
            </div>
            <div class="row">
...
<div class="our-facilties-section content-area-3">
    <div class="overlay">
        <div class="container">
            <!-- Main title -->
            <div class="main-title">
                <h1>Why Stay at Landmark Nike Lake Resort?</h1>
                <p>Every detail is designed to make your stay effortless, relaxing, and unforgettable. From sunrise to sunset, and every moment in between, you’ll find comfort, convenience, and care at every turn.</p>
            </div>
            <div class="row">
...
<div class="landmark-locations-section content-area-3" style="background-color: #f8f9fa; padding: 80px 0;">
    <div class="container">
        <!-- Main title -->
        <div class="main-title">
            <h1>Explore Our Other Locations</h1>
...
<div id="adModalOverlay" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.7); z-index:9999; display:flex; justify-content:center; align-items:center;">
    <div id="adModalContent" style="position:relative; background:transparent; border-radius:8px; box-shadow:0 2px 16px rgba(0,0,0,0.2); display:flex; flex-direction:column; align-items:center;">
        ...
        <img src="{{ asset('img/ad.jpg') }}" alt="Ad" style="max-width:90vw; max-height:80vh; border-radius:8px; box-shadow:0 2px 16px rgba(0,0,0,0.3); background:#fff; display:block; margin:auto;" />
    </div>
</div>
<script>
    $(document).ready(function() {
